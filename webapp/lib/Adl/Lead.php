...
/**
 * CompanyReferral stores data about the referring company
 * @author Mark Hobson
 */
class CompanyReferral extends CommonForm {
	
	protected $ReferralCompanyName;
	protected $Address1;
	protected $City;
	protected $StateDesc;
	...
	/**
	 * Returns the ReferralCompanyName
	 * @return string
	 */
	function getReferralCompanyName() {
		if (is_null($this->ReferralCompanyName)) {
			$this->ReferralCompanyName = "";
		}
		return $this->ReferralCompanyName;
	}
	
	/**
	 * Sets the ReferralCompanyName
	 * @var string
	 */
	function setReferralCompanyName($arg0) {
		$this->ReferralCompanyName = $arg0;
		$this->addModifiedColumn('ReferralCompanyName');
		return $this;
	}
	...
	function setName($arg0) {
		return $this->setReferralCompanyName($arg0);
	}
	 ...
	 * @var string
	 */
	function setCountryDesc($arg0) {
		$this->CountryDesc = $arg0;
		$this->addModifiedColumn('CountryDesc');
		return $this;
	}
	 ...
	 */
	function setCountry($arg0) {
		return $this->setCountryDesc($arg0);
	}
	 ...
	 */
	function setEmailAddress($arg0) {
		$this->EmailAddress = $arg0;
		$this->addModifiedColumn('EmailAddress');
		return $this;
	}
